...
public class FootballWidgetService extends RemoteViewsService {
    ...
    public class FootballRemoteViewsFactory implements RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            RemoteViews footballRemoteViews = new RemoteViews(mContext.getPackageName(), R.layout.football_widget_item);

            footballRemoteViews.setTextViewText(R.id.widget_home_name, homeName);
            footballRemoteViews.setTextViewText(R.id.widget_away_name, awayName);
